...
<header class="topbar">
    ...
    <nav>
        <?php if ($user): ?>
            <?php if (!$isAdmin): ?><a href="/onboarding">Onboarding</a><?php endif; ?>
...
<aside class="admin-sidebar">
    ...
    <div class="nav-group"><span>People</span><a class="<?= nav_active('/admin/users', $currentPath) ?>" href="/admin/users">Users</a></div>
