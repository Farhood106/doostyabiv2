...
function fa_label(?string $value): string
{
    ...
    $labels = [
        ...
        'phone' => 'شماره تلفن', 'email' => 'ایمیل', 'full_name' => 'نام کامل', 'username' => 'نام کاربری',
        'in_progress' => 'در حال پیگیری', 'technical_support' => 'پشتیبانی فنی', 'emotional_guidance' => 'همراهی انسانی', 'reporting_help' => 'کمک درباره گزارش', 'onboarding_help' => 'راهنمای شناخت‌نامه', 'conversation_help' => 'کمک برای شروع گفت‌وگو', 'safety_help' => 'کمک امنیتی',
    ];
