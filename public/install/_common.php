...
function install_expected_tables(): array
{
    return [
        ...
        'user_onboarding_progress', 'audit_logs', 'admin_settings', 'blocks', 'match_recommendation_queue', 'matches', 'chats', 'chat_participants', 'messages', 'message_flags', 'reveal_types', 'reveal_requests', 'match_visibility_snapshots', 'match_scores', 'match_cards', 'match_actions', 'match_explanations',
    ];
}
